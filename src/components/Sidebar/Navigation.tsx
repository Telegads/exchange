    ...
    <div className={style.navbar}>
      <ul>
        <li className={style.hover_left_line}>
          <a href="#">
            <span className={`${style.tooltip_document} ${style.tooltip}`}>
              Каталог
            </span>
            <svg
              width="24"
        ...
        <li className={style.hover_left_line}>
          <a href="company.html">
            <span className={`${style.tooltip_work} ${style.tooltip}`}>
              Мои кампании
            </span>
            <svg
              width="24"
        ...
        <li className={style.hover_left_line}>
          <a href="#">
            <span className={`${style.tooltip_category} ${style.tooltip}`}>
              Мои каналы
            </span>
            <svg
              width="24"
        ...
        <li className={style.hover_left_line}>
          <a href="#">
            <span className={`${style.tooltip_voice} ${style.tooltip}`}>
              Блог
            </span>
            <svg
              width="24"
        ...
        <li className={style.hover_left_line}>
          <a href="#">
            <span className={`${style.tooltip_info} ${style.tooltip}`}>
              База знаний
            </span>
            <svg
              width="24"
